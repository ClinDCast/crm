                ...
                aoColumns: [
                    {
                        ...
                        //     return `<a class="edit btn btn-success btn-sm"  href='edit_contact/${row.id}' ><i class="fas fa-edit"></i></a> <a class="btn btn-danger btn-circle btn-sm" onclick="if (!confirm('Are you sure? you want to delete this info')) return false;" href='delete_contact/${row.id}' title="Delete"><i class="fas fa-trash"></i></a>`;
                        //}
                    },
                    {
                        data: 'first_name',
                        // render: function(data, type, row) {
                        //     return `<a href='view_contact/${row.id}'>${row.first_name} ${row.last_name}</i></a>`;
                        // }
                    },
                    {
                        data: 'account_name',
                    ...
                    },
                    {
                        data: 'linkedin',
                        render: function(data, type, row) {
                            return `<a href='${row.linkedin}' target="_blank">${row.linkedin}</a>`;
                        }
                    },
                    {
                        data: 'follow_up_date',
