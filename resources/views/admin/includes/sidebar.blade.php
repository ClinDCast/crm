...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion _sidebar-style" id="accordionSidebar">
    ...
    @endif
    <li class="nav-item {{(Route::currentRouteName()=='reports' ||Route::currentRouteName()=='holiday_list' ||Route::currentRouteName()=='create_holiday' ||Route::currentRouteName()=='edit_holiday') ? 'active' : ''}}">
        <a class="nav-link {{(Route::currentRouteName()=='reports' ||Route::currentRouteName()=='holiday_list' ||Route::currentRouteName()=='create_holiday' ||Route::currentRouteName()=='edit_holiday' || Route::currentRouteName()=='attendencelist') ? '' : 'collapsed'}}" href="#" data-toggle="collapse" data-target="#collapseTwo3"
            aria-expanded="true" aria-controls="collapseTwo">
            <i class="fas fa-fw fa-cog"></i>
            <span>Time Entry Report</span>
        </a>
        <div id="collapseTwo3" class="collapse {{(Route::currentRouteName()=='reports' || Route::currentRouteName()=='attendencelist') ? 'show' : ''}}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
    ...
    @if(App\Models\Permission::admin_permission('daily_task') || App\Models\Permission::admin_permission('task_assignment') || App\Models\Permission::admin_permission('idea_board'))
        ...
        <a class="nav-link {{(Route::currentRouteName()=='dailytask_list' ||Route::currentRouteName()=='assigntask_list' || Route::currentRouteName()=='board') ? '' : 'collapsed'}}" href="#" data-toggle="collapse" data-target="#collapseTwoone"
            aria-expanded="true" aria-controls="collapseTwo">
            <i class="fas fa-fw fa-cog"></i>
    ...
    @if(App\Models\Permission::admin_permission('pmt') || App\Models\Permission::admin_permission('weekly_target'))
        <li class="nav-item {{(Route::currentRouteName()=='pmt_lists' || Route::currentRouteName()=='create_weekly_target' || Route::currentRouteName()=='searchweeklytarget' || Route::currentRouteName()=='weeklytargetactual') ? 'active' : ''}}">
            ...
            <div id="performance" class="collapse {{(Route::currentRouteName()=='pmt_lists' || Route::currentRouteName()=='create_weekly_target' || Route::currentRouteName()=='searchweeklytarget' || Route::currentRouteName()=='weeklytargetactual') ? 'show' : ''}}" aria-labelledby="headingUtilities"
    ...
    @if(App\Models\Permission::admin_permission('holiday_calender'))
        <li class="nav-item {{ (Route::currentRouteName()=='holiday_list' ||Route::currentRouteName()=='create_holiday' ||Route::currentRouteName()=='edit_holiday') ? 'active' : ''}}">
        <a class="nav-link" href="{{ route('holiday_list') }}">
            <i class="fas fa-fw fa-user"></i>
