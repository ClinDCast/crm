                                            ...
                                            <div class="lyte-tr">   
                                                        ...
                                                        <div class="lyteInputBox">
                                                            <div class="lyteField" style="border: 2px solid var(--formBorder); border-radius: 6px; height: 35px;">
                                                                <select id="client_name" >
                                                                    <option value="">Select</option>
                                                                    @foreach($account_ids as $ids)
                                                                        <option value="{{$ids->client_name}}"> {{ App\Models\Account::select('account_name')->where('id', $ids->client_name)->first()->account_name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                ...
                                                <lyte-td class="alignRight">  
                                                    <span class="customPluswithImpotBtnCon">  
                                                        <a href="{{ route('create_meeting') }}"><button class="customPlusBtn">Create Meeting</button> </a>
                                                    </span>   
                ...
                aoColumns: [
                    {
                        ...
                        //     return `<a class="edit btn btn-success btn-sm"  href='edit_meeting/${row.id}' ><i class="fas fa-edit"></i></a> <a class="btn btn-danger btn-circle btn-sm" onclick="if (!confirm('Are you sure? you want to delete this info')) return false;" href='delete_meeting/${row.id}' title="Delete"><i class="fas fa-trash"></i></a>`;
                        // }
                    },
                    {
                        data: 'organizer',
                    ...
                    },
                    {
                        data: 'meeting_title',
                        // render: function(data, type, row) {
                        //     return `<a href='view_meeting/${row.id}' >${row.meeting_title}</a>`;
                        // }
                    },
                    {
                        data: 'client_name',
