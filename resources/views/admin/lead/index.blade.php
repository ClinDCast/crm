                                            ...
                                            <div class="lyte-tr">
                                                ...
                                                <lyte-td class="alignRight">
                                                    <span class="customPluswithImpotBtnCon">
                                                        <a href="{{ route('create_lead') }}"><button class="customPlusBtn">Create Lead</button> </a>
                                                    </span>
                ...
                aoColumns: [
                    {
                        ...
                        render: function(data, type, row) {
                            return `<a class="edit btn btn-success btn-sm"  href='edit_lead/${row.id}' ><i class="fas fa-edit"></i></a>`;
                        }
                    },
                    {
                        data: 'first_name',
                        // render: function(data, type, row) {
                        //     return `<a href='view_account/${row.id}'>${row.first_name}</a>`;
                        // }
                    },
                    {
                        data: 'email',
