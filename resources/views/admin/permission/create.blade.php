...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="{{ route('create_permission') }}" class="btn btn-dark btn-icon-split">
                        ...
                        <div class="col-md-9">
                            <form action="{{ route('store_permission') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="description" name="description" placeholder="description" class="form-control" id="description" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="codename" name="codename" placeholder="codename" class="form-control" id="codename" required>
                                    </div>
                                </div>
